...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li class="active"><a href="home.php"><i class="icon-dashboard"></i><span>Home</span> </a> </li>
        <li><a href="posts.php"><i class="icon-list-alt"></i><span>Posts</span> </a> </li>
        <li><a href="post-manage.php"><i class="icon-wrench"></i><span>Gerenciar Postagens</span> </a></li>
